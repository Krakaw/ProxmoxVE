...
clear
cat <<"EOF"
  ______        _____ _____ ____ _   _   __  __  ___  ____  _____ 
 / ___\ \      / /_ _|_   _/ ___| | | | |  \/  |/ _ \|  _ \| ____|
 \___ \\ \ /\ / / | |  | || |   | |_| | | |\/| | | | | | | |  _|  
  ___) |\ V  V /  | |  | || |___|  _  | | |  | | |_| | |_| | |___ 
 |____/  \_/\_/  |___| |_| \____|_| |_| |_|  |_|\___/|____/|_____|
...
if [[ "$CURRENT_MODE" == "development" ]]; then
    echo -e "\nbash -c \"\$(wget -qLO - https://raw.githubusercontent.com/${GITHUB_USERNAME}/${REPO_NAME}/refs/heads/${BRANCH_NAME}/ct/${SCRIPT_NAME})\""
else
    echo -e "\nbash -c \"\$(wget -qLO - https://github.com/community-scripts/ProxmoxVE/raw/main/ct/${SCRIPT_NAME})\""
fi
